 ...
 */
class Notion_WP_Sync_Taxonomy_Destination extends Notion_WP_Sync_Abstract_Post_Destination {
	/**
	 * Destination slug.
	 *
	 * @var string
	 ...
	 *
	 * @var Notion_WP_Sync_Terms_Formatter
	 */
	 ...
	 * Constructor.
	 *
	 * @param Notion_WP_Sync_Terms_Formatter $term_formatter Term formatter dependency.
	 */
				...
				$taxonomy_options[] = array(
					...
					'form_options'          => array(
						array(
							...
							'type'  => 'checkbox',
							'label' => __( 'Split comma-separated string into terms', 'wp-sync-for-notion' ),
						),
					),
				);
			}
